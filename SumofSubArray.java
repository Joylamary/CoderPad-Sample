...
public class SumofSubArray {
	...
	static void sum_combinations_recursive(ArrayList<Integer> inputNumbers, int targetSum,
			ArrayList<Integer> partialNumbers) {
		int sum = 0;
		...
		// add the remaining numbers in the partial number list -  {1,2,3,4,10,15,20,35,50,100}++
